...
if (isset($_POST['Valider'])) {
        $Insert=$cnx->prepare("INSERT INTO ".$Prefix."neuro_Album (lien, created) VALUES(:lien, :created)");
...
<input type="file"  placeholder="Photo" name="photo"/></p>
...
while ($Photo=$SelectPhoto->fetch(PDO::FETCH_OBJ)) {
      ...
      echo $Photo->lien."<BR />";
      echo "<a href='$Home/Admin/Album/supprimer.php?id=$Photo->id'><img src='$Home/Admin/lib/img/supprimer.png'></a></p>";
}
?>
